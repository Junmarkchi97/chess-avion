...
class Chess {
  constructor() {
    ...
    this.piecesImages = {
      white_pawn: "./public/media/pieces/white_pawn.png",
      white_rook: "./public/media/pieces/white_rook.png",
      white_knight: "./public/media/pieces/white_knight.png",
      white_bishop: "./public/media/pieces/white_bishop.png",
      white_king: "./public/media/pieces/white_king.png",
      white_queen: "./public/media/pieces/white_queen.png",
      black_pawn: "./public/media/pieces/black_pawn.png",
      black_rook: "./public/media/pieces/black_rook.png",
      black_knight: "./public/media/pieces/black_knight.png",
      black_bishop: "./public/media/pieces/black_bishop.png",
      black_king: "./public/media/pieces/black_king.png",
      black_queen: "./public/media/pieces/black_queen.png",
    };
  }
